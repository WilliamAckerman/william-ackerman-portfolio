...
function OtherTechnicalSkills() {
    ...
    return (
        <>
            <h2 className="text-3xl text-center font-semibold text-gray-100">Other Technical Skills</h2><br />
            { otherTechnicalSkillLoading ? <p className="text-center text-gray-100">Loading other technical skills...</p> :
