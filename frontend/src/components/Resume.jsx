    ...
    return (
        ...
        >
            ...
            <section className="mb-2">
                ...
                <div className="mb-2">
                    ...
                    <ul className="list-disc list-inside">
                        <li className="text-sm sm:text-base mb-1 sm:mb-0 mt-1 sm:mt-0">Developing responsive, user-friendly websites using HTML, CSS, JavaScript, and Bootstrap</li>
                        <li className="text-sm sm:text-base mb-1 sm:mb-0">Improving UX through layout enhancements and accessibility considerations</li>
                        <li className="text-sm sm:text-base mb-1 sm:mb-0">Implementing database-driven features using complex SQL queries and PHP</li>
                        <li className="text-sm sm:text-base mb-1 sm:mb-0">Troubleshooting and resolving website issues to ensure functionality and accessibility</li>
                        <li className="text-sm sm:text-base mb-1 sm:mb-0">Communicating with project leads to discuss feature progress and deliverables</li>
                    </ul>
                </div>
                <div className="mb-2">
                    <h3
                    ...
                    <p><span className="font-semibold text-base sm:text-lg">Kelm Media Group</span>, Farmingdale, NY</p>
                    <ul className="list-disc list-inside">
                        <li className="text-sm sm:text-base mb-1 sm:mb-0 mt-1 sm:mt-0">Collaborated with team members to design and develop five responsive websites</li>
                        <li className="text-sm sm:text-base mb-1 sm:mb-0">Built user-friendly web pages using HTML, CSS, JavaScript, and Bootstrap</li>
                        <li className="text-sm sm:text-base mb-1 sm:mb-0">Implemented database-driven features using PHP and SQL</li>
                    </ul>
                </div>
            </section>
            <section className="mb-2">
            ...
            <section className="mb-2">
                ...
                <p className="text-sm sm:text-base mb-2 sm:mb-0"><strong>Frontend:</strong> HTML5, CSS3, JavaScript (ES6+), React, Bootstrap, AJAX, jQuery, TailwindCSS, Material UI, Vite, Vercel</p>
