import { FaEnvelope, FaPhoneAlt, FaLinkedin, FaGithub, FaLink, FaPrint } from "react-icons/fa";
    ...
    return (
        <>
            <section className="mb-2">
                {type == "print" ?
                <p className="text-3xl font-bold">William Ackerman</p>
                :
                <h1
                    className="
                        text-xl
                ...
                >
                    <span className={type == "print" ? "text-base mb-0 mr-4" : "text-base mb-2 md:mb-0 mr-4"}>
            ...
            <section className="mb-2">
                ...
                <div className="mb-2">
                    ...
                    <ul className="list-disc list-inside">
                        ...
                        <li className="text-base mb-0">
                            Performing seamless data retrieval through TanStack Query and an Express.js RESTful API
                        </li>
                        <li className="text-base mb-0">
                            Integrating Nodemailer with Gmail to create an easy-to-use messaging system
                        </li>
                    </ul>
                </div>
                ...
                <div className="mb-2">
                    ...
                    <ul className="list-disc list-inside">
                        ...
                        <li className="text-base mb-0">Participated in documenting system features and information</li>
                    </ul>
                </div>
            </section>
            <section className="mb-2">
